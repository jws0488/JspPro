	...
	<div id="div1">
		<div data-role="content">
			<div class="choice_list">
				...
				<ul>
					<li><h2>
							<a href="${path}/ractek/vc1.jsp" data-transition="slidedown">공격형</a>
						</h2></li>

					<li><h2>
							<a href="${path}/ractek/vc2.jsp" data-transition="slidedown">수비형</a>
						</h2></li>

					<li><h2>
							<a href="${path}/ractek/vc3.jsp" data-transition="slidedown">올라운드형</a>
						</h2></li>
				</ul>
